            ...
            <table>
                ...
                while ($row = mysqli_fetch_array($result)) {
                    ...
                    <tr>
                        ...
                        <td class="botao-acao">
                            <form action="realizadelfuncionarios.php" method="post">
                                <input type="hidden" name="id" value="<?php echo $row["id"]; ?>" />
                                <button class="botao-deletar" type="submit" name="botdelfuncionarios"
                                    value="ok">Del</button>
                            </form>
                        </td>
                        <td class="botao-acao">
                            <form action="formaltfuncionarios.php" method="post">
                                <input type="hidden" name="id" value="<?php echo $row["id"]; ?>" />
                                <button class="botao-alterar" type="submit" name="botaltfuncionarios"
                                    value="ok">Alt</button>
                            </form>
                        </td>
                    </tr>
