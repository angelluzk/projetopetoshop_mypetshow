...
<body>
    ...
    <main class="fixed-content">
        <h1>Lista de Serviços - ALTERAR/DELETAR</h1>
        ...
        <div class="table-wrapper">
            <table>
                ...
                $result = mysqli_query($con, "SELECT * FROM consultas");
                while ($row = mysqli_fetch_array($result)) {
                    ...
                    <tr>
                        ...
                        <td class="botao-acao">
                            <form action="realizadelconsultas.php" method="post">
                                <input type="hidden" name="id" value="<?php echo $row["id"]; ?>" />
                                <button class="botao-deletar" type="submit" name="botdelconsultas" value="ok">Del</button>
                            </form>
                        </td>
                        <td class="botao-acao">
                            <form action="formaltconsultas.php" method="post">
                                <input type="hidden" name="id" value="<?php echo $row["id"]; ?>" />
                                <button class="botao-alterar" type="submit" name="botaltconsultas" value="ok">Alt</button>
                            </form>
                        </td>
                    </tr>
                <?php }
